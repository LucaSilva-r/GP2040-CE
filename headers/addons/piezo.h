...
public:
    ...
    virtual void reinit() {}
    virtual std::string name() { return PiezoName; }
private:
    ...
    float magnitudeCalculation(int stick_num, piezo_instance & adc_inst);
    void radialDeadzone(int stick_num, piezo_instance & adc_inst);
